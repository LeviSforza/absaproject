...
from ..models.classic.lstm import LSTM
from ..models.plm.bert import BERT_MLP

_rnac_config_template = {
    "model": BERT_MLP,
    "optimizer": "adamw",
